...
def test_example(driver):
    ...
    for x in mass:
        ...
        if last != "0":
            ...
            for x1 in mass2:
                rf = rf + 1
                text_file2 = open('C:\\Users\\exe90\\Desktop\\site\\site\\5.txt', 'w')
                text_file2.write("zones[")
                text_file2.write(x1.text)
                #text_file2.write(str(rf))
                text_file2.write("][name]")
                text_file2 = open(r"C:\\Users\\exe90\\Desktop\\site\\site\\5.txt", "r")
    ...
    if f == j:
        ...
        # text_file1 = open('C:\\Users\\exe90\\Desktop\\site\\site\\5.txt', 'a')
