...
@pytest.fixture
def driver(request):
    #wd = webdriver.Ie("C:\\IEDriverServer\\IEDriverServer.exe")
    ...
    # dri = webdriver.Ie("C:\\IEDriverServer\\IEDriverServer.exe")
...
def test_example(driver):
    ...
    print(mass1)
    text_file = open("C:\\Users\\exe90\\Desktop\\site\\site\\3.txt", "w")
    for x in mass1:
        print('"//span[text()="', x.text, '"]"')
        text_file1 = open('C:\\Users\\exe90\\Desktop\\site\\site\\3.txt', 'a')
        text_file1.write("//span[text()='")
        text_file1.write(x.text)
        text_file1.write("']" + '\n')
        text_file1.close()

    with open(r"C:\\Users\\exe90\\Desktop\\site\\site\\3.txt", "r") as file:
        for lin in file:
            print(lin)
            time.sleep(1)
            ...
            print(ff)
            if ff > 0:
                text_file = open("C:\\Users\\exe90\\Desktop\\site\\site\\2.txt", "w")
                for x in c:
                    # print('"//p[text()="',x.text,'"]"')
                    text_file = open('C:\\Users\\exe90\\Desktop\\site\\site\\2.txt', 'a')
                ...
                with open(r"C:\\Users\\exe90\\Desktop\\site\\site\\2.txt", "r") as file:
                    for line in file:
                        print(line)
                        time.sleep(1)
    ...
    jk = 0
    nn = 0
    text_file2 = open("C:\\Users\\exe90\\Desktop\\site\\site\\4.txt", "w")
    for x in mas:
        # print('"//span[text()="', x.text, '"]"')
        s1 = x
        ...
        for x in r:
            mch = ["1","2","3","4","5"]
            text_file2 = open('C:\\Users\\exe90\\Desktop\\site\\site\\4.txt', 'a')
            text_file2.write(s1)
            ...
            rr = rr + 1
            text_file2.close()
    with open(r"C:\\Users\\exe90\\Desktop\\site\\site\\4.txt", "r") as file:
        for lines in file:
            print(lines)
            time.sleep(1)
    ...
    text_file = open("C:\\Users\\exe90\\Desktop\\site\\site\\1.txt", "w")
    text_file.write(repr(nn))
    time.sleep(1)
    text_file.close()
    os.startfile(r'"C:\\Users\\exe90\\Desktop\\site\\site\\1.txt"')
    print(nn)
